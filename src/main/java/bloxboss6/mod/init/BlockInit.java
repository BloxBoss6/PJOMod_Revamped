...
import bloxboss6.mod.objects.blocks.DragonToothCrop;
import bloxboss6.mod.objects.blocks.LaurelBush;
...
public class BlockInit {
    ...
    public static final Block DRAGON_TOOTH_CROP = new DragonToothCrop("dragon_tooth_crop");
    public static final Block LAUREL = new LaurelBush("laurel_bush");
